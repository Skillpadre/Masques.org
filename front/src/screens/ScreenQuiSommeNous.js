  ...
  return (
    <Layout style={{minHeight: '100vh', height: 'auto', backgroundColor: 'white',  color: 'black'}}className="layout">
      ...
      <Content style={{padding: '0 50px', display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '40px 0', textAlign: 'center', fontSize: 25}}>
        ...
        <Row style={{marginTop: 50}} align='middle'>
            <Col md={{span: 12}} sm={{span: 24}}>
                <p style={{marginLeft: 20}}>Vos achats sont solidaires. En effet, pour toute commande, nous faisons produire des masques, et les offrons aux personnes en situation de précarité. Nos partenaires ONG comme la Croix-Rouge, les dristribueront auprès des publics concernés. </p>
            </Col>
            <Col md={{span: 12}} sm={{span: 24}}>
